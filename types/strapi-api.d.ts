...
export interface paths {
    "/page-contents": {
        ...
        get: operations["page-content/get/page_contents"];
        put?: never;
        post: operations["page-content/post/page_contents"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/page-contents/{id}": {
        ...
        get: operations["page-content/get/page_contents_by_id"];
        put: operations["page-content/put/page_contents_by_id"];
        post?: never;
        delete: operations["page-content/delete/page_contents_by_id"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface operations {
    "page-content/get/page_contents": {
        parameters: {
            query?: {
                fields?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[];
                filters?: {
                    [key: string]: unknown;
                };
                _q?: string;
                ...
                sort?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt") | ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[] | {
                    [key: string]: "asc" | "desc";
                } | {
                    [key: string]: "asc" | "desc";
                }[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            body1?: string;
                            api_endpoint?: string;
                            postman_response?: unknown;
                            code?: string;
                            createdAt?: string;
                            updatedAt?: string;
                            /** @default 2025-12-18T02:03:59.462Z */
                            publishedAt: string;
                        }[];
                    };
                };
    ...
    "page-content/post/page_contents": {
        parameters: {
            query?: {
                fields?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[];
                populate?: "*" | never | never[];
            ...
            content: {
                "application/json": {
                    data: {
                        ...
                        postman_response?: unknown;
                        code?: string;
                        /** @default 2025-12-18T02:04:07.600Z */
                        publishedAt: string;
                    };
                };
            };
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            createdAt?: string;
                            updatedAt?: string;
                            /** @default 2025-12-18T02:03:59.470Z */
                            publishedAt: string;
                        };
                    };
                };
    ...
    "page-content/get/page_contents_by_id": {
        parameters: {
            query?: {
                fields?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[];
                populate?: "*" | never | never[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            createdAt?: string;
                            updatedAt?: string;
                            /** @default 2025-12-18T02:03:59.465Z */
                            publishedAt: string;
                        };
                    };
                };
    ...
    "page-content/put/page_contents_by_id": {
        parameters: {
            query?: {
                fields?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[];
                populate?: "*" | never | never[];
            ...
            content: {
                "application/json": {
                    data: {
                        ...
                        postman_response?: unknown;
                        code?: string;
                        /** @default 2025-12-18T02:03:59.472Z */
                        publishedAt?: string;
                    };
                };
            };
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            createdAt?: string;
                            updatedAt?: string;
                            /** @default 2025-12-18T02:03:59.474Z */
                            publishedAt: string;
                        };
                    };
                };
    ...
    "page-content/delete/page_contents_by_id": {
        parameters: {
            query?: {
                fields?: ("title" | "body1" | "api_endpoint" | "postman_response" | "code" | "createdAt" | "updatedAt" | "publishedAt")[];
                populate?: "*" | never | never[];
                ...
                content: {
                    "application/json": {
                        data: {
                            ...
                            createdAt?: string;
                            updatedAt?: string;
                            /** @default 2025-12-18T02:03:59.477Z */
                            publishedAt: string;
                        };
                    };
                };
